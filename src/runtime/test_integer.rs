...
mod tests {
  ...
  fn test_exec_pop_ioperand_integer() {
    ...
    jvm
      .push_frame_from_class("TestInteger", "pop_ioperand", "()V", vec![])
      .unwrap();
  ...
  fn test_exec_iload_integer() {
    ...
    jvm
      .push_frame_from_class("TestInteger", "iload", "()V", vec![])
      .unwrap();
  ...
  fn test_exec_istore() {
    ...
    jvm
      .push_frame_from_class("TestInteger", "istore", "()V", vec![])
      .unwrap();
  ...
  fn test_exec_iconst() {
    ...
    jvm
      .push_frame_from_class("TestInteger", "iconst", "()V", vec![])
      .unwrap();
  ...
  fn test_exec_iushr() {
    ...
    jvm
      .push_frame_from_class("TestInteger", "iushr", "()V", vec![])
      .unwrap();
  ...
  fn test_exec_ishl() {
    ...
    jvm
      .push_frame_from_class("TestInteger", "ishl", "()V", vec![])
      .unwrap();
  ...
  fn test_exec_ishr() {
    ...
    jvm
      .push_frame_from_class("TestInteger", "ishr", "()V", vec![])
      .unwrap();
  ...
  fn test_exec_i2f() {
    ...
    jvm
      .push_frame_from_class("TestInteger", "i2", "()V", vec![])
      .unwrap();
  ...
  fn test_exec_if() {
    ...
    for opcode in opcodes {
      for value in &values {
        ...
        jvm
          .push_frame_from_class("TestInteger", "_if", "()V", vec![])
          .unwrap();
    ...
    for opcode in opcodes {
      for i in 0..values1.len() {
        ...
        if (opcode == crate::runtime::opcode::OpCode::IFICMPEQ && values1[i] == values2[i])
          || (opcode == crate::runtime::opcode::OpCode::IFICMPNE && values1[i] != values2[i])
          || (opcode == crate::runtime::opcode::OpCode::IFICMPLT && values1[i] < values2[i])
          || (opcode == crate::runtime::opcode::OpCode::IFICMPLE && values1[i] <= values2[i])
          || (opcode == crate::runtime::opcode::OpCode::IFICMPGT && values1[i] > values2[i])
          || (opcode == crate::runtime::opcode::OpCode::IFICMPGE && values1[i] >= values2[i])
        {
          assert!(jvm.get_current_frame().unwrap().get_pc() == prev_pc + offset);
        } else {
          assert!(jvm.get_current_frame().unwrap().get_pc() == prev_pc + 3);
  ...
  fn test_exec_iadd() {
    ...
    jvm
      .push_frame_from_class("TestInteger", "arithmetic", "()V", vec![])
      .unwrap();
  ...
  fn test_exec_ireturn() {
    ...
    jvm
      .push_frame_from_class("TestInteger", "ireturn", "()V", vec![])
      .unwrap();
    ...
    assert!(jvm.get_current_frame().unwrap().get_method_name() == "arithmetic");

    assert!(Some(types::Type::Integer(v1)) == jvm.exec_ireturn().unwrap());

    assert!(jvm.get_current_frame().unwrap().get_classname() == "TestInteger");

    assert!(jvm.get_current_frame().unwrap().get_method_name() == "ireturn");
