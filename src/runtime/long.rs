...
impl JVM {
  ...
  pub(crate) fn exec_lload(&mut self, index: usize) -> Result<Option<types::Type>> {
    let toload = self.get_current_frame()?.get_local(index)?.as_long()?;
    self.push_stack(types::Type::Long(toload))?;
    Ok(None)
  }
  ...
  pub(crate) fn exec_ladd(&mut self) -> Result<Option<types::Type>> {
    ...
    self.push_stack(types::Type::Long(v1.wrapping_add(v2)))?;
  ...
  pub(crate) fn exec_lsub(&mut self) -> Result<Option<types::Type>> {
    ...
    self.push_stack(types::Type::Long(v1.wrapping_sub(v2)))?;
  ...
  pub(crate) fn exec_ldiv(&mut self) -> Result<Option<types::Type>> {
    ...
    self.push_stack(types::Type::Long(v1.wrapping_div(v2)))?;
  ...
  pub(crate) fn exec_lmul(&mut self) -> Result<Option<types::Type>> {
    ...
    self.push_stack(types::Type::Long(v1.wrapping_mul(v2)))?;
  ...
  pub(crate) fn exec_lxor(&mut self) -> Result<Option<types::Type>> {
    ...
    self.push_stack(types::Type::Long(v1 ^ v2))?;
  ...
  pub(crate) fn exec_lneg(&mut self) -> Result<Option<types::Type>> {
    let v1 = self.pop_loperand()?;

    self.push_stack(types::Type::Long(v1.wrapping_neg()))?;
  ...
  pub(crate) fn exec_lconst(&mut self, index: ju2) -> Result<Option<types::Type>> {
    self.push_stack(types::Type::Long(index as i64))?;
