...
mod tests {
  ...
  fn test_exec_aconstnull() {
    ...
    jvm
      .push_frame_from_class("TestReference", "aconstnull", "()V", vec![])
      .unwrap();
  ...
  fn test_exec_aload() {
    ...
    jvm
      .push_frame_from_class("TestReference", "aload", "()V", vec![])
      .unwrap();
  ...
  fn test_exec_astore() {
    ...
    jvm
      .push_frame_from_class("TestReference", "astore", "()V", vec![])
      .unwrap();
  ...
  fn test_exec_if_acmp() {
    ...
    for (v1, v2) in values {
      for opcode in &opcodes {
        ...
        jvm
          .push_frame_from_class("TestReference", "if_acmp", "()V", vec![])
          .unwrap();
  ...
  fn test_exec_areturn() {
    ...
    jvm
      .push_frame_from_class("TestReference", "areturn", "()V", vec![])
      .unwrap();
    ...
    assert!(jvm.get_current_frame().unwrap().get_method_name() == "if_acmp");

    assert!(Some(types::Type::ObjectRef(v1)) == jvm.exec_areturn().unwrap());

    assert!(jvm.get_current_frame().unwrap().get_classname() == "TestReference");

    assert!(jvm.get_current_frame().unwrap().get_method_name() == "areturn");
