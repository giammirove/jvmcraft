...
mod tests {
  ...
  fn test_exec_fload() {
    ...
    jvm
      .push_frame_from_class("TestFloat", "fload", "()V", vec![])
      .unwrap();
  ...
  fn test_exec_fstore() {
    ...
    jvm
      .push_frame_from_class("TestFloat", "fstore", "()V", vec![])
      .unwrap();
  ...
  fn test_exec_fconst() {
    ...
    jvm
      .push_frame_from_class("TestFloat", "fconst", "()V", vec![])
      .unwrap();
  ...
  fn test_exec_f2d() {
    ...
    jvm
      .push_frame_from_class("TestFloat", "f2", "()V", vec![])
      .unwrap();
  ...
  fn test_exec_fcmpg() {
    ...
    for i in 0..values1.len() {
      ...
      jvm
        .push_frame_from_class("TestFloat", "_if", "()V", vec![])
        .unwrap();
  ...
  fn test_exec_fadd() {
    ...
    jvm
      .push_frame_from_class("TestFloat", "arithmetic", "()V", vec![])
      .unwrap();
  ...
  fn test_exec_freturn() {
    ...
    jvm
      .push_frame_from_class("TestFloat", "freturn", "()V", vec![])
      .unwrap();
    ...
    assert!(jvm.get_current_frame().unwrap().get_method_name() == "freturn");
